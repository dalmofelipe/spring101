...
import com.github.dalmofelipe.spring101.entities.LocalWeatherEntity;
...
public class LocationWeatherController {
	...
	public LocationWeatherController(IpApiService ipApService, ClimaTempoService climaTempoService) {
		this.ipApService = ipApService;
		this.climaTempoService = climaTempoService;
	}
	
	@GetMapping
	public LocalWeatherEntity getMeassury() {
